...
export const projects: Project[] = [
  {
    ...
    tags: ["Python", "OpenAI Realtime API", "RAG", "FAISS", "LINE Bot", "Tkinter", "VLC", "Cloudflare"],
    featured: true,
    coverImage: "HIV_hospital/mm_icon.png",
    video: "HIV_hospital/Magic Mirror.mp4",
    images: [
      "HIV_hospital/user_process.jpg",
      "HIV_hospital/device-back.jpg",
      "HIV_hospital/meeting-discussion.jpg",
      "HIV_hospital/hospital-discussion-01.jpg",
      "HIV_hospital/hospital-discussion-02.jpg",
    ],
  },
  {
    id: 2,
    ...
    tags: ["Python", "Discord Bot", "VTube Studio", "OBS", "LLM", "OpenAI API", "RAG", "FAISS", "Cartesia TTS", "WebSocket"],
    featured: true,
    coverImage: "norgo_ai_vtuber/core-design-philosophy.png",
    video: "norgo_ai_vtuber/Norgo Project.mp4",
    images: [
      "norgo_ai_vtuber/Norgo System overall architecture diagram.png",
      "norgo_ai_vtuber/project-results.png",
      "norgo_ai_vtuber/interaction-performance-stats.png",
      "norgo_ai_vtuber/llm.png",
      "norgo_ai_vtuber/stt.png",
      "norgo_ai_vtuber/tts.png",
      "norgo_ai_vtuber/tts-survey.png",
      "norgo_ai_vtuber/rag.png",
      "norgo_ai_vtuber/rag-win-rate-comparison.png",
      "norgo_ai_vtuber/vts.png",
    ],
  },
  {
    id: 3,
    ...
    featured: true,
    coverImage: "E-Scooter/Yunscoo logo.png",
    githubUrl: "https://github.com/SA-Group1/escooter-api",
    images: [
      "E-Scooter/Campus escooter Rental System .png",
      "E-Scooter/Login Page Intro .png",
      "E-Scooter/Sign Up Page Intro .png",
      "E-Scooter/Menu Page Intro .png",
      "E-Scooter/Profile Page Intro .png",
      "E-Scooter/Edit Profile Dialog Intro .png",
      "E-Scooter/Payment Page Intro .png",
      "E-Scooter/Add Credit Card Dialog Intro .png",
      "E-Scooter/Unbind Credit Card Dialog Intro.png",
      "E-Scooter/Rent Info Dialog Intro .png",
      "E-Scooter/Rent Record Page Intro .png",
      "E-Scooter/Return Page Intro .png",
    ],
  },
  {
    id: 4,
